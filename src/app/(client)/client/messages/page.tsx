        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <div className="flex items-center justify-between gap-3 border-b border-border/70 px-5 py-4 sm:px-6 sm:py-5">
            <div className="min-w-0 space-y-1">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-muted-foreground/70">Messages</p>
              <h1 className="text-lg font-semibold tracking-tight text-foreground">Chat with our team about your projects</h1>
            </div>
          </div>

          <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
            <ConversationV2 currentUserRole="CLIENT" />
          </div>
        </div>
      </section>
    </div>
